...
MSA.LOC.SpanishMX = function()
    ...
    MSA_L["WARNING - COUNTDOWN TO LOGOFF TRIGGERED!!!"]="¡ADVERTENCIA - CUENTA REGRESIVA DE DESCONEXIÓN INICIADA!"
    ...
    MSA_L["Crating has ended prematurely on a complex salvage recipe with multiple reagents. Checking stacks of secondary {name1} reagent. One moment..."]="La fabricación ha terminado prematuramente en una receta de recuperación compleja con múltiples componentes. Verificando pilas del componente secundario {name1}. Un momento..."
    MSA_L["No secondary reagent stacks to combine. Please check your available reagents and start again."]="No hay pilas de componentes secundarios para combinar. Por favor, revisa tus componentes disponibles y empieza de nuevo."
    MSA_L["No secondary reagent stacks to combine. Please check your available {name1} and start again."]="No hay pilas de componentes secundarios para combinar. Por favor, revisa tus {name1} disponibles y empieza de nuevo."
    MSA_L["Crafting has ended prematurely. Please restart and crafting will continue nonstop"]="La fabricación ha terminado prematuramente. Por favor, reinicia y la fabricación continuará sin parar."
    ...
    MSA_L["Combining {num1} stacks..."]="Combinando {num1} pilas..."
    ...
    MSA_L["Please type \'/msa craft recipe_id item_id\'"]="Por favor, escribe \'/msa crear ID_receta ID_objeto\'"
    MSA_L["Example: /msa craft 382981 191461"]="Ejemplo: /msa crear 382981 191461"
    ...
    MSA_L["Initial stack is too small. Stacks are being combined. One moment..."]="La pila inicial es demasiado pequeña. Se están combinando las pilas. Un momento..."
    ...
    MSA_L["Nonstop crafting is currently disabled. Please type \'/msa enable\' to continue nonstop."]="La fabricación continua está desactivada. Escribe \'/msa activar\' para continuar sin parar."
    MSA_L["Nonstop crafting has been enabled"]="La fabricación continua ha sido activada"
    MSA_L["Nonstop crafting is already enabled"]="La fabricación continua ya está activada"
    MSA_L["Nonstop crafting has been disabled"]="La fabricación continua ha sido desactivada"
    MSA_L["Nonstop crafting is already disabled"]="La fabricación continua ya está desactivada"
    ...
    MSA_L['/msa craft recipe_id item_id']="/msa crear ID_receta ID_objeto"
    MSA_L['/msa craft 382981 191461']="/msa crear 382981 191461"
    ...
    -- MSA_UI.lua
    MSA_L["Nonstop Crafting"]="Fabricación Continua"
    MSA_L["MSA Limitation: Nonstop will only work for reagents within player bags, not bank tabs."]="Limitación de MSA: El modo continuo solo funciona con componentes en las bolsas, no en el banco."
    ...
    MSA_L["Alert 2: 20 Second offline countdown"]="Alerta 2: Cuenta regresiva de 20 segundos para desconexión"
    MSA_L["Play Sound When Player Goes AFK"]="Reproducir sonido cuando el jugador se ausente"
    MSA_L["Sound will trigger only during nonstop crafting."]="El sonido solo sonará durante la fabricación continua."
    MSA_L["Play Sound When Offline Countdown Timer Begins"]="Reproducir sonido al inicio de la cuenta regresiva de desconexión"
    MSA_L["Sound will trigger only during nonstop crafting."]="El sonido solo sonará durante la fabricación continua."
    ...
    MSA_L["The correct reagent stacked has been selected for mass processing."] = "La bonne pile de composants a été sélectionnée pour le traitement de masse."
    MSA_L["Warning! Mass processing your reagent will fail due to first available stack being too small ({num1}). Combining stacks now... Please re-select your reagent and try again."] = "Attention ! Le traitement de masse de votre composant va échouer car la première pile disponible est trop petite ({num1}). Combinaison des piles en cours... Veuillez resélectionner votre composant et réessayer."
    MSA_L["Warning! MSA nonstop crafting will fail once this stack finishes. You must choose the correct reagent stack to process or they cannot be auto-combined."] = "Attention ! L'artisanat en continu de MSA échouera une fois cette pile terminée. Vous devez choisir la bonne pile de composants à traiter, sinon elles ne pourront pas être combinées automatiquement."
    MSA_L["Correct Reagent to Select:"] = "Composant correct à sélectionner :"
    MSA_L["Bag #{num1}"] = "Sac n°{num1}"
    MSA_L["Bag-Slot #{num1}: {name1} - Stack Size = {num2}"] = "Sac-Emplacement n°{num1} : {name1} - Taille de la pile = {num2}"
    MSA_L["Please note, the Bag index begins at 1, for your Backpack, and 5 for the reagent bag. The slot position begins in the top left and counts going right."] = "Veuillez noter que l'index des sacs commence à 1 pour votre Sac à dos, et à 5 pour le sac de composants. La position de l'emplacement commence en haut à gauche et se compte vers la droite."
