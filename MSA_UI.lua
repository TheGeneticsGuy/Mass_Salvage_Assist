...
UI.LoadUI = function()
    ...
    if not UI.MSA_checkbox then
        ...
        UI.MSA_checkbox = CreateFrame("CheckButton", "MSA_checkbox", ProfessionsFrame.CraftingPage,
    ...
    if not UI.MSA_Timer_Button then
        --- TIMER BUTTON
        UI.MSA_Timer_Button = CreateFrame("Button", "MSA_Timer_Button", ProfessionsFrame.CraftingPage.SchematicForm,
    ...
    if not UI.MSA_ProfWindow_Settings then
        UI.MSA_Settings_DirectionButton = CreateFrame("Button", "FCF_GlobalInfoButton", ProfessionsFrame.CraftingPage,
        ...
        UI.MSA_ProfWindow_Settings = CreateFrame("Frame", "MSA_ProfWindow_Settings", UI.MSA_Settings_DirectionButton,
            "TranslucentFrameTemplate");
        UI.MSA_ProfWindow_Settings.CloseButton = CreateFrame("Button", nil, UI.MSA_ProfWindow_Settings,
            "UIPanelCloseButton");
        UI.MSA_ProfWindow_Settings:Hide();
        ...
        UI.MSA_ProfWindow_Settings:SetScript("OnUpdate", function(self, elapsed)
            ...
            if self.timer > 0.1 then
                ...
                if not self.locked and not self:IsMouseOver(1, -1, -20, 1) and
                    not UI.MSA_Settings_DirectionButton:IsMouseOver() then
                    self:Hide();
                end
    ...
    if not UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox then
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox = CreateFrame("CheckButton", "MSA_AFK_Alert_Checkbox",
            UI.MSA_ProfWindow_Settings, "InterfaceOptionsCheckButtonTemplate")
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox.value = MSA_save.afkAlarm[1]
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox:SetChecked(
            UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox.value);
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox:SetPoint("TOPLEFT", UI.MSA_ProfWindow_Settings, "TOPLEFT", 15,
            -15);

        -- Text to the right of checkbox
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox.Text =
            UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox:CreateFontString(nil, "OVERLAY", "GameFontNormal")
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox.Text:SetPoint("LEFT", UI.MSA_ProfWindow_Settings
            .MSA_AFK_Alert_Checkbox, "RIGHT", 2, 0)

        -- Normalize the click area of check button to length of the text
        UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox:SetHitRectInsets(0, 0 -
            UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox.Text:GetWidth() - 2, 0, 0);
    ...
    if not UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1 then
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1 = CreateFrame("CheckButton", "MSA_AFK_Sound1",
            UI.MSA_ProfWindow_Settings, "InterfaceOptionsCheckButtonTemplate")
        ...
        -- Text to the right of checkbox
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1.Text = UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1:CreateFontString(nil,
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1.Text:SetPoint("LEFT", UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1,
            "RIGHT", 1, 0)

        -- Normalize the click area of check button to length of the text
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1:SetHitRectInsets(0, 0 -
            UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1.Text:GetWidth() - 2, 0, 0);

        -- Ensures this is always to the left of the CreateAllButton, accounting for width of text also
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1:SetPoint("TOPLEFT", UI.MSA_ProfWindow_Settings.MSA_AFK_Alert_Checkbox,
            "BOTTOMRIGHT", 0, -3);
    ...
    if not UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2 then
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2 = CreateFrame("CheckButton", "MSA_AFK_Sound2",
            UI.MSA_ProfWindow_Settings, "InterfaceOptionsCheckButtonTemplate")
        ...
        -- Text to the right of checkbox
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2.Text = UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2:CreateFontString(nil,
            "OVERLAY", "GameFontNormal")
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2.Text:SetPoint("LEFT", UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2,
            "RIGHT", 1, 0)

        -- Normalize the click area of check button to length of the text
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2:SetHitRectInsets(0, 0 -
            UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2.Text:GetWidth() - 2, 0, 0);

        -- Ensures this is always to the left of the CreateAllButton, accounting for width of text also
        UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2:SetPoint("TOPLEFT", UI.MSA_ProfWindow_Settings.MSA_AFK_Sound1,
            "BOTTOMLEFT", 0, -3);
    ...
    if not UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound then
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound = CreateFrame("CheckButton", "MSA_AFK_ForceSound",
            UI.MSA_ProfWindow_Settings, "InterfaceOptionsCheckButtonTemplate")
        ...
        -- Text to the right of checkbox
        UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound.Text =
            UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound:CreateFontString(nil, "OVERLAY", "GameFontNormal")
        ...
        UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound.Text:SetPoint("LEFT",
            UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound, "RIGHT", 1, 0)

        -- Normalize the click area of check button to length of the text
        UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound:SetHitRectInsets(0, 0 -
            UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound.Text:GetWidth() - 2, 0, 0);

        -- Ensures this is always to the left of the CreateAllButton, accounting for width of text also
        UI.MSA_ProfWindow_Settings.MSA_AFK_ForceSound:SetPoint("TOPLEFT", UI.MSA_ProfWindow_Settings.MSA_AFK_Sound2,
            "BOTTOMLEFT", 0, -3);
...
UI.Deploy_Timer_UI = function()
    ...
    if not UI.CT_Core_Frame then
        ...
        -- Close Button
        UI.CT_Core_Frame.CT_CloseButton =
            CreateFrame("Button", "CT_CloseButton", UI.CT_Core_Frame, "UIPanelCloseButton");
        ...
        UI.CT_Core_Frame.Always_Show_Checkbox = CreateFrame("CheckButton", "Always_Show_Checkbox", UI.CT_Core_Frame,
            "InterfaceOptionsCheckButtonTemplate")
        ...
        -- Text to the right of checkbox
        UI.CT_Core_Frame.Always_Show_Checkbox.Text = UI.CT_Core_Frame.Always_Show_Checkbox:CreateFontString(nil,
            "OVERLAY", "GameFontNormal")
        ...
        -- Normalize the click area of check button to length of the text
        UI.CT_Core_Frame.Always_Show_Checkbox:SetHitRectInsets(0, 0 -
            UI.CT_Core_Frame.Always_Show_Checkbox.Text:GetWidth() - 2, 0, 0);
        ...
        UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox = CreateFrame("CheckButton", "MSA_In_Bags_Only_Checkbox",
            UI.CT_Core_Frame, "InterfaceOptionsCheckButtonTemplate")
        ...
        -- Text to the right of checkbox
        UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox.Text = UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox:CreateFontString(
        ...
        UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox.Text:SetPoint("LEFT", UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox,
            "RIGHT", 2, 0)

        -- Normalize the click area of check button to length of the text
        UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox:SetHitRectInsets(0, 0 -
            UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox.Text:GetWidth() - 2, 0, 0);

        -- Ensures this is always to the left of the CreateAllButton, accounting for width of text also
        UI.CT_Core_Frame.MSA_In_Bags_Only_Checkbox:SetPoint("BOTTOMLEFT", UI.CT_Core_Frame.Always_Show_Checkbox,
            "TOPLEFT", 0, 0)
...
UI.Configure_TWW_Ench = function(hide_frame)
    ...
    if not UI.EnchBuff_Checkbox and ProfessionsFrame and ProfessionsFrame.CraftingPage then
        ...
        UI.EnchBuff_Checkbox = CreateFrame("CheckButton", "EnchBuff_Checkbox", ProfessionsFrame.CraftingPage,
            "InterfaceOptionsCheckButtonTemplate")
        ...
        -- Ensures this is always to the left of the CreateAllButton, accounting for width of text also
        UI.EnchBuff_Checkbox:SetPoint("TOPLEFT", ProfessionsFrame.CraftingPage.SchematicForm.Reagents, "BOTTOMLEFT", 0,
            -5)
        ...
        UI.EnchBuff_Sound_Checkbox = CreateFrame("CheckButton", "EnchBuff_Sound_Checkbox", UI.EnchBuff_Checkbox,
            "InterfaceOptionsCheckButtonTemplate")
